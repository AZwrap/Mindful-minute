...
export default function StatsScreen({ navigation, route }: Props) {
  ...
  useEffect(() => {
    ...
    const now = new Date();
    let cutoffDate = new Date(0); // Default to epoch
                ...
                {writingPatterns ? (
                  <View style={styles.insightsGrid}>
                    <View style={styles.insightItem}>
                      ...
                      <Text 
                        style={[styles.insightValue, { color: palette.accent }]}
                        numberOfLines={1}
                    ...
                    {writingAnalytics.timeStats && (
                      <View style={styles.timeAnalysis}>
                        ...
                        <View style={styles.timeBars}>
                          {Object.entries(writingAnalytics.timeStats.slots).map(([time, count]: [string, any]) => (
