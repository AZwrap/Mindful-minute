...
export default function AchievementsScreen({ navigation }: Props) {
  ...
  // Retrieve data using the selector pattern
  // Note: We cast state as 'any' here if the store type definition isn't fully updated 
  // with the complex 'getAchievements' function yet.
  const achievementsData = useProgress((state: any) => state.getAchievements)() as AchievementsData;
