...
// Mindful Time (New Category)
  'time_10m': { id: 'time_10m', name: 'Breathing Space', description: 'Spend 10 minutes journaling', category: 'mindfulness', tier: 'bronze' },
  'time_1h': { id: 'time_1h', name: 'Deep Diver', description: '1 hour of total mindful time', category: 'mindfulness', tier: 'silver' },
  'time_5h': { id: 'time_5h', name: 'Time Traveler', description: '5 hours of reflection recorded', category: 'mindfulness', tier: 'gold' },
};
  // --------------------------------------------------
// TYPES
// --------------------------------------------------
