...
console.log("SETTINGS DEBUG:", {
  sunrise: settings.dynamicSunrise,
  sunset: settings.dynamicSunset,
  full: settings
});
...
{settings.dynamicSunrise ? formatTime(settings.dynamicSunrise) : "Select"}
      </Text>
    </Pressable>
  </View>
...
onPress={() => {
  ...
  setPickerVisible(true);
    ...
    >
      <Text style={{ color: palette.main }}>
{settings.dynamicSunset ? formatTime(settings.dynamicSunset) : "Select"}
      </Text>
    </Pressable>
  </View>
