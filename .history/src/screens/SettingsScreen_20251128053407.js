...
// TIME VALUES (CORRECTLY SUBSCRIBED)
...
{theme === "dynamic" && (
  <View style={{ marginTop: 12, gap: 12 }}>
    {/* DYNAMIC THEME TIMES */}
<Text style={styles.sectionTitle}>Dynamic Theme Times</Text>
...
timeBox: {
  ...
  borderRadius: 14,
  borderWidth: 1,
  borderColor: palette.border,  // fixed
  backgroundColor: palette.card, // fixed
  justifyContent: "center",
  alignItems: "center",

  // NEW clean styling → same size, sleek, premium
  minHeight: 54,
  flexDirection: "row",
  gap: 6,
