                ...
                <PremiumPressable onPress={handleCloudSave} haptic="light" style={[styles.menuItem, { borderBottomWidth: 1, borderBottomColor: palette.border }]}>
                    <View style={styles.menuItemContent}>
                        ...
                        <View>
                            ...
                            <Text style={[styles.menuItemSub, { color: palette.sub, fontSize: 11 }]}>Save stats & entries online</Text>
                        </View>
                    </View>
                ...
                <PremiumPressable onPress={handleCloudRestore} haptic="medium" style={[styles.menuItem, { borderBottomWidth: 1, borderBottomColor: palette.border }]}>
                    <View style={styles.menuItemContent}>
                        ...
                        <View>
                            ...
                            <Text style={[styles.menuItemSub, { color: palette.sub, fontSize: 11 }]}>Recover data from cloud</Text>
                        </View>
                    </View>
                    <Text style={{ color: palette.subtleText }}>›</Text>
                </PremiumPressable>
                  <PremiumPressable onPress={generateTherapistReport} style={[styles.menuItem, { borderBottomWidth: 1, borderBottomColor: palette.border }]}>
                    <View style={styles.menuItemContent}><FileText size={20} color={palette.accent} /><View><Text style={[styles.menuItemTitle, { color: palette.text }]}>Therapist Report</Text></View></View>
                  </PremiumPressable>
                  {/* CLOUD OPTIONS */}
                  <PremiumPressable onPress={handleCloudSave} style={[styles.menuItem, { borderBottomWidth: 1, borderBottomColor: palette.border }]}>
                    <View style={styles.menuItemContent}>
                        <Cloud size={20} color={palette.accent} />
                        <View>
                            <Text style={[styles.menuItemTitle, { color: palette.text }]}>Sync to Cloud</Text>
                            <Text style={[styles.description, { color: palette.sub, fontSize: 11 }]}>Save stats & entries online</Text>
                        </View>
                    </View>
                  </PremiumPressable>

                  <PremiumPressable onPress={handleCloudRestore} style={[styles.menuItem, { borderBottomWidth: 1, borderBottomColor: palette.border }]}>
                    <View style={styles.menuItemContent}>
                        <CloudDownload size={20} color={palette.accent} />
                        <View>
                            <Text style={[styles.menuItemTitle, { color: palette.text }]}>Restore from Cloud</Text>
                            <Text style={[styles.description, { color: palette.sub, fontSize: 11 }]}>Recover data from cloud</Text>
                        </View>
                    </View>
                  </PremiumPressable>
                  <PremiumPressable onPress={handleBackup} style={[styles.menuItem, { borderBottomWidth: 1, borderBottomColor: palette.border }]}>
                    <View style={styles.menuItemContent}><Database size={20} color={palette.accent} /><View><Text style={[styles.menuItemTitle, { color: palette.text }]}>Backup Data</Text></View></View>
                  </PremiumPressable>
                  <PremiumPressable onPress={handleRestore} style={[styles.menuItem, { borderBottomWidth: 1, borderBottomColor: palette.border }]}>
                    <View style={styles.menuItemContent}><RotateCcw size={20} color={palette.accent} /><View><Text style={[styles.menuItemTitle, { color: palette.text }]}>Restore Backup</Text></View></View>
                  </PremiumPressable>
                  <PremiumPressable onPress={exportAllEntries} style={styles.menuItem}>
                    <View style={styles.menuItemContent}><Share size={20} color={palette.accent} /><View><Text style={[styles.menuItemTitle, { color: palette.text }]}>Export as Text</Text></View></View>
                  </PremiumPressable>
                </View>
              </View>
