...
renderSectionHeader={({ section: { title } }) => (
              <View style={{
                backgroundColor: isDark ? '#0F172A' : '#F8FAFC', // Matches screen background seamlessly
                paddingVertical: 12,
                paddingHorizontal: 16, // Aligns with your list items
                borderBottomWidth: 1,
                borderBottomColor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)', // Very subtle divider line
              }}>
                <Text style={{
                  fontSize: 13,
                  fontWeight: '700',
                  color: '#6366F1', // Uses your brand accent color (Indigo)
