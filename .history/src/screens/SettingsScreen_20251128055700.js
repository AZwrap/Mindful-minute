...
<Text style={{ fontSize: 14, color: "#E5E7EB", fontWeight: "600" }}>
  {settings.sunriseTime ? new Date(settings.sunriseTime).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) : "Select"}
</Text>
      </Text>
    </Pressable>
  </View>
...
onPress={() => {
  ...
  setPickerVisible(true);
    ...
    >
      <Text style={{ color: palette.main }}>
<Text style={{ fontSize: 14, color: "#E5E7EB", fontWeight: "600" }}>
  {settings.sunsetTime ? new Date(settings.sunsetTime).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) : "Select"}
</Text>
      </Text>
    </Pressable>
  </View>
