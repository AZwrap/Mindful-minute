...
// Temporary debug - check if file exists
import * as MoodAnalysis from '../utils/moodAnalysis';
console.log('MoodAnalysis exports:', Object.keys(MoodAnalysis));
...
{moodStats.map((stat, index) => (
  ...
  >
    <View style={styles.statHeader}>
      <Text style={[styles.moodName, { color: textMain }]}>
        {stat.mood.charAt(0).toUpperCase() + stat.mood.slice(1)} {/* Add capitalization */}
      </Text>
