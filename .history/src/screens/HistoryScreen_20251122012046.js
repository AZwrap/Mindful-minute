...
deleteButton: {
  flex: 1,                             // fill the swipeActions height
  marginVertical: 12,                  // smaller than row (same as entryItem padding)
  backgroundColor: '#EF4444',
  justifyContent: 'center',
  alignItems: 'center',
  borderTopRightRadius: 12,            // match entryItem radius
...
entryWrapper: {
  borderRadius: 12,
  overflow: 'hidden',     // 🔥 THIS LINE IS THE MAGIC
},
});