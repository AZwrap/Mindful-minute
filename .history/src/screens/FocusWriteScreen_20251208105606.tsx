...
// Selectors with default fallback to ensure Zen Mode appears
  const hapticsEnabled = useSettings((s) => s.hapticsEnabled);
  const zenModeEnabled = useSettings((s) => s.zenModeEnabled ?? true); 
...
{/* Native size prop ensures crisp vectors and proper layout */}
              <View style={{ marginVertical: 40 }}>
                <BreathingCircle running={true} isDark={isDark} size={220} />
              </View>
