...
export default function FocusWriteScreen() {
  ...
  const handleSaveAndExit = () => {
    ...
    navigation.navigate('Write', { 
      date, 
      prompt,
      text: text, // This passes the text back to WriteScreen
      fromFocusMode: true // Optional flag to indicate coming from focus mode
    });
  };
      ...
      >
        <Animated.View style={[styles.content, { opacity: fadeAnim }]}>
          ...
          >
            ...
            {/* Progress Indicator - 200 word target */}
