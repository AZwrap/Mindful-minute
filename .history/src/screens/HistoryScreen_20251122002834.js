...
swipeActions: {
  width: 65,                // enough space for "Delete" without feeling huge
  justifyContent: 'center',
},
  swipeAction: {
    flex: 1,
...
deleteButton: {
  flex: 1,                  // fill the whole swipeActions area
  justifyContent: 'center',
  alignItems: 'center',
  backgroundColor: '#EF4444',
  borderRadius: 8,
  // remove height: it will match the row automatically
  // remove width: it's controlled by swipeActions
  // remove marginLeft: 2, it can visually cause a “cut” feeling on the right
},
swipeActionText: {
  color: 'white',
  fontWeight: '600',
  fontSize: 14,             // slightly smaller so it fits comfortably
  textAlign: 'center',
...
entryWrapper: {
  borderRadius: 12,
  overflow: 'hidden',   // 🔥 makes the swipe height identical to the visible card
},
