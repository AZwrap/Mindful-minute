      ...
      {prompt?.explanation && (
        ...
        <Animated.View style={[
          ...
          <TextInput
            ...
            placeholderTextColor={isGratitudeMode ? (isDark ? '#A5B4FC' : '#4F46E5') : placeholderCol}
            multiline
            style={[
              styles.input,
              {
            ...
            haptic="light"
              ...
              { 
                backgroundColor: isGratitudeMode 
                  ...
                  : 'transparent',
                borderColor: isGratitudeMode ? (isDark ? '#818CF8' : '#6366F1') : 'rgba(99,102,241,0.3)'
              }
            ]}
          >
            <Text style={[
              styles.gratitudeToggleText,
              { color: isGratitudeMode ? (isDark ? '#A5B4FC' : '#4F46E5') : (isDark ? '#CBD5E1' : '#334155') }
            ]}>
