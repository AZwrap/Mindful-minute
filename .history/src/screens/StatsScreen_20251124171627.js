...
const generateGratitudeReport = (entries, gratitudeStreak, totalGratitudeEntries) => {
  ...
  // Calculate positivity score (simplified)
...
const isDark = currentTheme === 'dark';
  ...
  const gratitudeReport = useMemo(() => 
  generateGratitudeReport(entries, gratitudeStreak, totalGratitudeEntries), 
  [entries, gratitudeStreak, totalGratitudeEntries]
);
            ...
            <View style={[
              ...
              <View style={styles.reportGrid}>
                <View style={styles.reportItem}>
                  <Text style={[styles.reportLabel, { color: textSub }]}>Gratitude Entries</Text>
                  <Text style={[styles.reportValue, { color: '#22C55E' }]}>
                    {gratitudeReport.gratitudeEntriesCount}
                  </Text>
                  <Text style={[styles.reportSub, { color: textSub }]}>
                    {gratitudeReport.gratitudePercentage}% of recent entries
                  </Text>
                </View>
                
                <View style={styles.reportItem}>
                  <Text style={[styles.reportLabel, { color: textSub }]}>Current Streak</Text>
                  <Text style={[styles.reportValue, { color: '#22C55E' }]}>
                    {gratitudeReport.currentStreak} days
                  </Text>
                  <Text style={[styles.reportSub, { color: textSub }]}>
                    Keep it going! 🔥
                  </Text>
              ...
              {gratitudeReport.positivityDifference > 0 && (
                <View style={styles.positivitySection}>
                  <Text style={[styles.positivityTitle, { color: textMain }]}>
                    ✨ Gratitude Boost
                  </Text>
                  <Text style={[styles.positivityText, { color: textSub }]}>
                    Your gratitude entries are {gratitudeReport.positivityDifference}% more positive than regular entries
                  </Text>
                </View>
              )}
              
              {/* Mood Patterns */}
              <View style={styles.moodPatternSection}>
                <Text style={[styles.patternTitle, { color: textSub }]}>Common Moods</Text>
                <View style={styles.moodComparison}>
                  <View style={styles.moodType}>
                    <Text style={[styles.moodTypeLabel, { color: textSub }]}>Gratitude:</Text>
                    <Text style={[styles.moodValue, { color: '#22C55E' }]}>
                      {gratitudeReport.topGratitudeMood || 'No data'}
                    </Text>
                  </View>
                  <View style={styles.moodType}>
                    <Text style={[styles.moodTypeLabel, { color: textSub }]}>Regular:</Text>
                    <Text style={[styles.moodValue, { color: '#6366F1' }]}>
                      {gratitudeReport.topRegularMood || 'No data'}
                    </Text>
                  </View>
                </View>
              </View>
              ...
              <View style={styles.encouragement}>
                <Text style={[styles.encouragementText, { color: isDark ? '#4ADE80' : '#16A34A' }]}>
                  💫 Your gratitude practice is making a difference!
                </Text>
              </View>
            </View>
          )}
  ...
  <View 
    style={[
      ...
      { 
        ...
        backgroundColor: '#6366F1',
        opacity: stat.percentage / 100 // Use opacity for visual weight
      }
    ]} 
  />
</View>
...
emptySubtitle: {
  ...
  percentageBar: {
    height: 6,
    backgroundColor: '#E5E7EB', // or your border color
    borderRadius: 3,
    marginBottom: 6,
    overflow: 'hidden',
  ...
  percentageFill: {
    height: '100%',
    borderRadius: 3,
    // Remove any fixed width from here
  },
  percentageText: {
    fontSize: 12,
    fontWeight: '500',
