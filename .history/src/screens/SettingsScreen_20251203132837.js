...
// Removed UIManager.setLayoutAnimationEnabledExperimental to fix warning on New Architecture
...
export default function SettingsScreen({ navigation }) {
  ...
  const generateTherapistReport = async () => {
     // Simple placeholder logic - in real app you'd generate the PDF/Text
     Alert.alert("Report Ready", "Clinical summary ready to share.");
  };
            ...
            <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
              ...
              <View style={[styles.card, { backgroundColor: palette.card, borderColor: palette.border }]}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 16 }}>
                  ...
                  />
                  <PremiumPressable
                    onPress={() => { if (!breakInvalid) { setBreakDuration(breakParsed); showToast('Break duration updated'); }}}
                    disabled={breakInvalid}
                    style={[styles.applyBtn, { backgroundColor: breakInvalid ? '#CBD5E1' : palette.accent }]}
                  >
                    <Text style={{ color: 'white', fontWeight: '600', fontSize: 12 }}>Apply</Text>
                  </PremiumPressable>
                </View>
              ...
              {/* 5. DATA & PRIVACY (RESTORED BUTTONS) */}
              <View style={[styles.section, { marginTop: 8 }]}>
                ...
                <View style={[styles.menuGroup, { backgroundColor: palette.card, borderColor: palette.border }]}>
                  ...
                  {/* Restored Restore & Export Buttons */}
