...
// Optimized: Only re-renders if props change
...
renderItem={({ item }) => (
            ...
            getItemLayout={(data, index) => (
              { length: 110, offset: 110 * index, index } // Optimization: Helps FlatList skip measurements if height is roughly fixed
            )}
          />
        </View>
      </Animated.View>
...
moodText: {
    fontSize: 12,
    fontWeight: '600',
    textTransform: 'capitalize', // <--- Forces "happy" to display as "Happy"
  },
  recentMoodsSection: {
    paddingHorizontal: 8,
    paddingTop: 4,
...
recentMoodText: {
    fontSize: 12,
    fontWeight: '600',
    textTransform: 'capitalize', // <--- Ensures the filter chips at the top match
  },
  entryReflection: {
    fontSize: 14,
    lineHeight: 20,
