...
swipeActions: {
    ...
    justifyContent: 'center',
    alignItems: 'center',
    // Ensure the container itself doesn't force height
    flex: 1, 
  },
  swipeAction: {
    flex: 1,
...
deleteButton: {
    ...
    // Match the mood tag border radius
    borderRadius: 12,
    // Use padding instead of fixed height so it wraps the text snugly
    paddingVertical: 6,
  ...
  swipeActionText: {
    color: 'white',
    fontWeight: '600',
    // Reduce font size to match the mood tag text size
    fontSize: 12,
    textAlign: 'center',
  },
});