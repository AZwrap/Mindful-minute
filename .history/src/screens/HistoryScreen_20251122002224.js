...
const styles = StyleSheet.create({
  ...
  swipeActions: {
    flexDirection: 'row',
    width: 55,          // keep width narrow if you like
    // 👇 remove height: 100
    // height: 100,
  },
  swipeAction: {
  ...
  deleteButton: {
    ...
    alignSelf: 'stretch',       // make sure it stretches with the row
    justifyContent: 'center',
    alignItems: 'center',
    borderRadius: 8,
    marginLeft: 2,
    ...
    // 👇 remove height: 100
    // height: 100,
    // width is optional; if you want a bit more room:
    // width: 55,  // or bump to 70 if "Delete" feels cramped
  },
  swipeActionText: {
    color: 'white',
    fontWeight: '600',
