...
const [sunrise, setSunrise] = useState(settings.dynamicSunrise || "06:00");
const [sunset, setSunset] = useState(settings.dynamicSunset || "18:00");
  ...
  {showThemeDropdown && (
    ...
    >
      {[
        ...
        { value: "dynamic", label: "Dynamic (Sunrise/Sunset)" },
      ].map((opt) => (
        <Pressable
          key={opt.value}
          onPress={() => {
        ...
        >
          <Text
            style={[
              ...
              {
                color:
                  theme === opt.value ? palette.primary : palette.text,
