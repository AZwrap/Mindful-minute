...
deleteButton: {
  width: 70,
  height: '70%', // Slightly smaller to fit better when scaled
  justifyContent: 'center',
  alignItems: 'center',
...
deleteButtonWrapper: {
  width: 100, // Increased to give more space
  height: '100%',
  justifyContent: 'center',
  alignItems: 'flex-start', // Align to left so button has room to scale
  paddingLeft: 8, // Add some padding so it doesn't touch the edge
},
