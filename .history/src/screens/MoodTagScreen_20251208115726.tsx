...
// @ts-ignore
import { MOOD_PLAYLISTS } from '../constants/moodCategories';
...
const [achievementQueue, setAchievementQueue] = useState([]);
  ...
  const handleMusicPress = () => {
    const playlist = MOOD_PLAYLISTS[selectedMood];
    if (playlist) {
      Linking.openURL(playlist.url).catch(err => console.error("Couldn't load page", err));
    }
  };
...
{/* Music Recommender */}
            {selectedMood && MOOD_PLAYLISTS[selectedMood] && (
