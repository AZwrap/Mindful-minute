...
const getPalette = () => {
  ...
  // Generate a raw JSON backup for data safety/restore
  const handleBackup = async () => {
    try {
      // 1. Get all raw data
      const rawData = useEntriesStore.getState().entries;
      const backupObject = {
        version: 1,
      ...
      // 3. Save and Share
      const fileName = `MindfulMinute_Backup_${Date.now()}.json`;
      const fileUri = FileSystem.documentDirectory + fileName;
...
{/* SECURITY SECTION */}
            <View style={[styles.section, { marginTop: 32 }]}> {/* <--- Added spacing */}
              <Text style={[styles.sectionTitle, { color: palette.subtleText }]}>Privacy</Text>
              <View style={[styles.card, { backgroundColor: palette.card, borderColor: palette.border }]}>
                {/* Reduced paddingVertical from default 12 to 6 for a slimmer look */}
                <View style={[styles.row, { paddingVertical: 6, alignItems: 'center' }]}>
                  <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                    {/* Reduced icon padding from 8 to 6 */}
                    <View style={[styles.iconBox, { padding: 6, backgroundColor: isDark ? 'rgba(16, 185, 129, 0.1)' : '#ECFDF5' }]}>
                      <Text style={{ fontSize: 16 }}>🔒</Text>
                    </View>
                    <View>
                      <Text style={[styles.label, { color: palette.text }]}>Biometric Lock</Text>
                      <Text style={[styles.subLabel, { color: palette.subtleText, fontSize: 12 }]}>
                        FaceID / Fingerprint
                      </Text>
                    </View>
                  </View>
...
<View style={{ marginTop: 24, marginBottom: 8 }}>
  <Text style={[styles.label, { color: palette.text, marginBottom: 12 }]}>
    Accent Color
  </Text>
...
{/* DATA MANAGEMENT */}
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: palette.subtleText }]}>Data & Privacy</Text>
...
{/* 1. Therapist Report */}
                ...
                >
                  <View style={styles.menuItemContent}>
                    ...
                    <View>
                      ...
                      <Text style={[styles.menuItemSub, { color: palette.subtleText }]}>30-day clinical summary</Text>
                    </View>
                  </View>
                ...
                >
                  <View style={styles.menuItemContent}>
                    ...
                    <View>
                      <Text style={[styles.menuItemTitle, { color: palette.text }]}>Backup Data</Text>
                      <Text style={[styles.menuItemSub, { color: palette.subtleText }]}>Save JSON to device</Text>
                    </View>
                  </View>
                  <Text style={{ color: palette.subtleText }}>›</Text>
                </PremiumPressable>
                ...
                >
                  <View style={styles.menuItemContent}>
                    ...
                    <View>
                      ...
                      <Text style={[styles.menuItemSub, { color: palette.subtleText }]}>Overwrite app from file</Text>
                    </View>
                  </View>
                  <Text style={{ color: palette.subtleText }}>›</Text>
                </PremiumPressable>
                ...
                >
                  <View style={styles.menuItemContent}>
                    ...
                    <View>
                      ...
                      <Text style={[styles.menuItemSub, { color: palette.subtleText }]}>Plain text for reading</Text>
                    </View>
                  </View>
                  <Text style={{ color: palette.subtleText }}>›</Text>
                </PremiumPressable>
...
<PremiumPressable
              ...
              >
                <Text style={{ color: isDark ? '#F87171' : '#DC2626', fontWeight: '700', fontSize: 15 }}>
