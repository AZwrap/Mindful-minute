...
const SwipeableEntry = ({ 
  ...
  const renderRightActions = (progress, dragX) => {
    const scale = dragX.interpolate({
      inputRange: [-65, -65, 0],  // Fixed: three values needed
      outputRange: [1, 1, 0],     // Fixed: three values needed
      extrapolate: 'clamp',
    });
...
const styles = StyleSheet.create({
  ...
  entryItem: {
    paddingHorizontal: 12, // Only horizontal padding
    paddingVertical: 0, // No vertical padding
    borderRadius: 12,
    borderWidth: 1,
    marginBottom: 8,
    height: 100, // Change from minHeight to exact height
  ...
  swipeActions: {
    flexDirection: 'row',
    width: 60,
    height: '100%', // Take full height of the swipeable container
    marginRight: -8,
  },
  swipeAction: {
    flex: 1,
  ...
  deleteButton: {
    ...
    alignItems: 'center',
    width: 60,
    height: '100%', // Match the swipeable container height
    borderRadius: 8,
    marginLeft: 2,
  },
  swipeActionText: {
