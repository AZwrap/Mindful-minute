...
swipeActions: {
  width: 90,                 // how far you can swipe to reveal
  justifyContent: 'center',  // center vertically within the row
  alignItems: 'flex-end',    // keep button tight to the right edge
},

deleteButton: {
  paddingHorizontal: 18,
  paddingVertical: 10,       // controls HEIGHT of the button
  borderRadius: 999,         // nice pill / fully rounded corners
  backgroundColor: '#EF4444',
  marginRight: 8,            // a little gap from the edge (optional)
  justifyContent: 'center',
  alignItems: 'center',
},
...
entryWrapper: {
  overflow: 'hidden',   // 🔥 key line: sets row height = card height
  borderRadius: 12,     // keeps nice corners
},
