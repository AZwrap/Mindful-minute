...
renderSectionHeader={({ section: { title } }) => (
              <View style={{
                backgroundColor: isDark ? '#0F172A' : '#F8FAFC', // Solid background stops content bleeding behind
                paddingVertical: 16, // More breathing room
                paddingHorizontal: 8,
                borderBottomWidth: 1,
                borderBottomColor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)', // Extremely subtle separator
              }}>
                <Text style={{
                  fontSize: 13,
                  fontWeight: '700',
                  color: isDark ? '#94A3B8' : '#64748B', // Subtle slate color instead of bright accent
