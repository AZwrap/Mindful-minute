...
<ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
              ...
              {/* 1. MAIN CONFIG CARD: Appearance, Theme, Privacy */}
              <View style={[styles.card, { backgroundColor: palette.card, borderColor: palette.border, paddingBottom: 12 }]}>
                ...
                {/* Dynamic Times (Visible ONLY when Dynamic) */}
                {/* This sits perfectly between Theme and Privacy now */}
                {theme === "dynamic" && (
              ...
              {/* 2. ACCENT COLOR (Now Outside, between Appearance and Feedback) */}
              {/* Hidden if theme is Dynamic */}
              {theme !== "dynamic" && (
                <View style={{ marginTop: 8, marginBottom: 8 }}>
                  <Text style={[styles.label, { color: palette.sub, marginBottom: 12, marginLeft: 4 }]}>
                    Accent Color
                  </Text>
