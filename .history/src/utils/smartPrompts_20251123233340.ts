...
export const extractThemes = (text) => {
  ...
  const stopWords = new Set(['the', 'and', 'but', 'for', 'with', 'this', 'that', 'was', 'were', 'have', 'has', 'had', 'what', 'when', 'where', 'why', 'how', 'just', 'like', 'from', 'about', 'would', 'could', 'should', 'been', 'they', 'their', 'there', 'your', 'you', 'are', 'were', 'will', 'then', 'than', 'them', 'these', 'those']);
...
export const analyzeSentiment = (text) => {
  ...
  const positiveWords = ['happy', 'good', 'great', 'love', 'peace', 'calm', 'grateful', 'joy', 'content', 'excited', 'proud', 'thankful', 'amazing', 'wonderful', 'beautiful', 'fantastic', 'excellent', 'bliss', 'serene', 'hopeful'];
  const negativeWords = ['sad', 'bad', 'stress', 'anxious', 'worried', 'angry', 'tired', 'hard', 'frustrated', 'overwhelmed', 'stressed', 'upset', 'anxiety', 'depressed', 'exhausted', 'difficult', 'struggle', 'pain', 'hurt', 'fear'];
