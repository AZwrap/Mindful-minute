      ...
      >
        ...
        <View style={styles.promptSection}>
          ...
          <View style={[styles.promptCard, { backgroundColor: isDark ? '#1F2937' : '#FFFFFF' }]}>
            <Text style={[styles.promptText, { color: isDark ? '#E5E7EB' : '#0F172A' }]}>
              {todayPrompt.text}
            </Text>
            {todayPrompt.explanation && (
              <Text style={[styles.promptExplanation, { color: isDark ? '#94A3B8' : '#64748B' }]}>
                💡 {todayPrompt.explanation}
              </Text>
            )}
            {todayPrompt.isSmart && (
          ...
          <PremiumPressable
            ...
            haptic="medium"
            style={[styles.writeButton, { backgroundColor: currentVariant.bg }]}
            accessible={true}
            accessibilityRole="button"
            accessibilityLabel={primaryA11yLabel}
          >
            <Text style={[styles.writeButtonText, { color: currentVariant.text }]}>
              {primaryLabel}
            </Text>
          </PremiumPressable>
        </View>
